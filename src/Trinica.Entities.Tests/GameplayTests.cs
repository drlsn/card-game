...
public class GameplayTests
{
    ...
    public void PlayHeroesAndUnits()
    {
        ...
        Assert.IsTrue(game.AssignDiceToCard(player1Id, diceIndex: 1, cardsToLay1[0].SourceCardId));
        Assert.IsTrue(game.AssignDiceToCard(player2Id, diceIndex: 1, cardsToLay2[0].SourceCardId));
        Assert.IsTrue(game.AssignDiceToCard(player1Id, diceIndex: 2, cardsToLay1[1].SourceCardId));
        Assert.IsTrue(game.AssignDiceToCard(player2Id, diceIndex: 2, cardsToLay2[1].SourceCardId));
        Assert.IsTrue(game.AssignDiceToCard(player1Id, diceIndex: 3, cardsToLay1[2].SourceCardId));
        Assert.IsTrue(game.AssignDiceToCard(player2Id, diceIndex: 3, cardsToLay2[2].SourceCardId));
        Assert.IsTrue(game.ConfirmAssignDicesToCards(player1Id));
        Assert.IsTrue(game.ConfirmAssignDicesToCards(player2Id));
    ...
    public void PlayHeroesAndNoEffectSpells()
    {
        // Player 1
        var hero1Card = CreateHeroCard("hero-1", speed: 20);
        var spellCard1 = CreateSpellCard("spell-1", damage: 20);
        ...
        // Player 2
        var hero2Card = CreateHeroCard("hero-2");
        var spellCard2 = CreateSpellCard("spell-2", damage: 5);
        ...
        Assert.IsTrue(game.AssignDiceToCard(player1Id, diceIndex: 0, hero1Card.Id));
        Assert.IsTrue(game.AssignDiceToCard(player2Id, diceIndex: 0, hero2Card.Id));
        Assert.IsTrue(game.AssignDiceToCard(player1Id, diceIndex: 1, spellCard1.Id));
        Assert.IsTrue(game.AssignDiceToCard(player2Id, diceIndex: 1, spellCard2.Id));
        Assert.IsTrue(game.ConfirmAssignDicesToCards(player1Id));
        Assert.IsTrue(game.ConfirmAssignDicesToCards(player2Id));
        Assert.IsTrue(game.AssignCardTarget(player1Id, hero1Card.Id, hero2Card.Id));
        Assert.IsTrue(game.AssignCardTarget(player2Id, hero2Card.Id, hero1Card.Id));
    ...
    public static Gameplay.Cards.SpellCard CreateSpellCard(
        SpellCardId id, int damage = 10)
    {
        return new Gameplay.Cards.SpellCard(id, new IEffect[] {}, new[] { Element.Storm }, damage);
    }

    public static Gameplay.Cards.SpellCard CreateSpellCard(string id, 
        int damage = 10)
    {
        var cardId = new SpellCardId(id);
        return new Gameplay.Cards.SpellCard(cardId, new IEffect[] { }, new[] { Element.Storm }, damage);
    }
